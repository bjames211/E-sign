...
export function RefundsSection({
  ...
  return (
    <div style={styles.section}>
      <h4 style={styles.title}>REFUNDS ISSUED</h4>
      <div style={styles.content}>
                ...
                return (
                  ...
                  >
                    ...
                    <td style={styles.descriptionCell}>
                      {entry.description || 'Refund'}
                      {entry.changeOrderNumber && (
                        <span style={styles.changeOrderTag}>
                          {entry.changeOrderNumber}
                        </span>
                      )}
        ...
        <div style={styles.totalRow}>
          <span style={styles.totalLabel}>Total Refunded:</span>
          <span style={styles.totalValue}>{formatCurrency(totalRefunded)}</span>
        </div>
        {pendingAmount > 0 && (
