...
import { OrderFormFiles, PendingFile } from '../../types/order';

interface FileUploadSectionProps {
  files: OrderFormFiles;
  onChange: (files: OrderFormFiles) => void;
}
  ...
  return (
    <div style={styles.section}>
      ...
      <div style={styles.uploadGrid}>
        {/* Order Form PDF - Required for e-sign */}
        <FileDropzone
          label="Order Form PDF"
          description="This PDF will be sent to the customer for e-signature"
        ...
        <FileDropzone
          label="3D Renderings"
          description="Upload building renderings (images)"
          accept={{
        ...
        <FileDropzone
          ...
          description="Documents and files to send to the installer"
          accept={{
            'application/pdf': ['.pdf'],
            'image/*': ['.png', '.jpg', '.jpeg', '.gif'],
            'application/msword': ['.doc'],
